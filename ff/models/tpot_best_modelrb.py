...
def rbmod(df_list):
    ...
    # Average CV score on the training set was: -4.439883776859836
    exported_pipeline = make_pipeline(
        SelectPercentile(score_func=f_regression, percentile=42),
        RandomForestRegressor(bootstrap=False, max_features=0.1, min_samples_leaf=6, min_samples_split=10, n_estimators=100)
    )
